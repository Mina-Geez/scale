  ...
  if (
    ...
    erpnext.PointOfSale.Controller.prototype.on_cart_update = async function (
      ...
      try {
        ...
        var from_selector = field === "qty" && typeof value === "number";
        if (from_selector) {
        ...
        if (item_row_exists) {
          ...
          var { item_code, batch_no, serial_no, rate, uom } = item;
          ...
          var new_item = { item_code, batch_no, rate, uom, [field]: value };
          ...
          if (field === "qty" && value !== 0 && !this.allow_negative_stock) {
            var qty_needed = value * item_row.conversion_factor;
            await this.check_stock_availability(
              item_row,
              qty_needed,
              this.frm.doc.set_warehouse
